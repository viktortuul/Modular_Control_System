...
Start ..\..\Model_GUI\Model_GUI\bin\Debug\Model_GUI.exe controller_ep=127.0.0.1:8400:8300 channel_controller=127.0.0.1:8222 model=dwt:5,0:0,3:5,0:0,2:0,0001 log=true log_file_name=standard_10_90
...
Start ..\..\Model_GUI\Model_GUI\bin\Debug\Model_GUI.exe controller_ep=127.0.0.1:8401:8301 channel_controller=127.0.0.1:8222 model=dwt:5,0:0,3:5,0:0,2:0,0001 log=true log_file_name=plus_10_90
...
Start ..\..\Model_GUI\Model_GUI\bin\Debug\Model_GUI.exe controller_ep=127.0.0.1:8402:8302 channel_controller=127.0.0.1:8222 model=dwt:5,0:0,3:5,0:0,2:0,0001 log=true log_file_name=suppress_10_90
