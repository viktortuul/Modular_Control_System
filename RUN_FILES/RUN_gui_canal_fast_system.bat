...
Start ..\Canal_GUI\Canal_GUI\bin\Debug\Canal_GUI.exe port_receive=8111 bernoulli=90
Start ..\Canal_GUI\Canal_GUI\bin\Debug\Canal_GUI.exe port_receive=8222 markov=80:98
