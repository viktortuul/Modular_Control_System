...
Start ..\Model_GUI\Model_GUI\bin\Debug\Model_GUI.exe controller_ep=127.0.0.1:8400:8300 channel_controller=127.0.0.1:8222 model=dwt:5,0:0,3:5,0:0,2:0,0001 log=false
...
REM Start ..\Model_GUI\Model_GUI\bin\Debug\Model_GUI.exe controller_ep=127.0.0.1:8401:8301 channel_controller=127.0.0.1:8222 model=dwt:5,0:0,3:5,0:0,2:0,0001 log=false

REM Start ..\Controller\Controller\bin\Debug\Controller.exe gui_ep=127.0.0.1:8102:8202 plant_ep=127.0.0.1:8302:8402 channel_gui=127.0.0.1:8111 channel_plant=127.0.0.1:8222 controller=PID_SUPPRESS control_range=-50:50 log=false
REM Start ..\Model_GUI\Model_GUI\bin\Debug\Model_GUI.exe controller_ep=127.0.0.1:8402:8302 channel_controller=127.0.0.1:8222 model=dwt:5,0:0,3:5,0:0,2:0,0001 log=false
